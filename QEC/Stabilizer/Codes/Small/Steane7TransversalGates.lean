...
lemma transversalH_conjugates_stabilizer_to_stabilizer (g : NQubitPauliGroupElement 7)
  ...
  have hgen :
    ...
    · simpa [stabilizerGroup_toSubgroup_eq, swapXZ_element] using transversalSwapXZ_mem_subgroup x hxList
    · apply Subtype.ext
      simpa [conjByGate_val, NQubitPauliGroupElement.gate_val, transversalH_Steane7,
        uniformTransversalGate_coe, transversalH_Steane7,
        uniformTransversalGate_coe] using
  ...
  simpa [conjByGate_val, NQubitPauliGroupElement.gate_val, transversalH_Steane7,
        uniformTransversalGate_coe, transversalH_Steane7,
        uniformTransversalGate_coe] using congrArg Subtype.val hgg'
...
lemma transversalS_conjugates_Z_generator (g : NQubitPauliGroupElement 7) (hg : g ∈ ZGenerators) :
  ...
  simpa [transversalS_Steane7, uniformTransversalGate_coe,
         NQubitPauliGroupElement.toMatrix,
...
private lemma transversalS_conjugates_XI_phase0_card4_gate
  ...
  simpa [conjByGate_val, transversalS_Steane7, uniformTransversalGate_coe,
    NQubitPauliGroupElement.gate_val,
...
theorem transversalS_Steane7_isLogicalS :
  ...
  · apply Subtype.ext
    ...
    -- v4.34: unfold the `LogicalQubitOps.logicalY` projection explicitly (the
    -- bare `logicalY` in scope is the Steane7 file's own definition).
    simpa [conjByGate_val, NQubitPauliGroupElement.gate_val, transversalS_Steane7,
        uniformTransversalGate_coe, LogicalQubitOps.logicalY, logicalY] using hXY
