...
@[simp] lemma X_on_ket0 : X • |0⟩ = |1⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (X : Matrix QubitBasis QubitBasis ℂ) (ket0 : Vector QubitBasis)
    = (ket1 : Vector QubitBasis)
  ext i
  fin_cases i <;> simp +decide [coe_X, Xmat, ket0, ket1, Matrix.mulVec, dotProduct]

/-- X flips |1⟩ to |0⟩. -/
@[simp] lemma X_on_ket1 : X • |1⟩ = |0⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (X : Matrix QubitBasis QubitBasis ℂ) (ket1 : Vector QubitBasis)
    = (ket0 : Vector QubitBasis)
  ext i
  fin_cases i <;> simp +decide [coe_X, Xmat, ket0, ket1, Matrix.mulVec, dotProduct]
...
lemma CNOT_on_ket00 : CNOT • |00⟩ = |00⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (CNOT : Matrix TwoQubitBasis TwoQubitBasis ℂ) (ket00 : Vector TwoQubitBasis)
    = (ket00 : Vector TwoQubitBasis)
  ext i
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [CNOT, controllize, Xmat, ket00, Matrix.mulVec, dotProduct,
      Matrix.of_apply]

/-- CNOT maps |01⟩ to |01⟩. -/
lemma CNOT_on_ket01 : CNOT • |01⟩ = |01⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (CNOT : Matrix TwoQubitBasis TwoQubitBasis ℂ) (ket01 : Vector TwoQubitBasis)
    = (ket01 : Vector TwoQubitBasis)
  ext i
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [CNOT, controllize, Xmat, ket01, Matrix.mulVec, dotProduct,
      Matrix.of_apply]

/-- CNOT maps |10⟩ to |11⟩. -/
lemma CNOT_on_ket10 : CNOT • |10⟩ = |11⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (CNOT : Matrix TwoQubitBasis TwoQubitBasis ℂ) (ket10 : Vector TwoQubitBasis)
    = (ket11 : Vector TwoQubitBasis)
  ext i
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [CNOT, controllize, Xmat, ket10, ket11, Matrix.mulVec, dotProduct,
      Matrix.of_apply]

/-- CNOT maps |11⟩ to |10⟩. -/
lemma CNOT_on_ket11 : CNOT • |11⟩ = |10⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (CNOT : Matrix TwoQubitBasis TwoQubitBasis ℂ) (ket11 : Vector TwoQubitBasis)
    = (ket10 : Vector TwoQubitBasis)
  ext i
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [CNOT, controllize, Xmat, ket10, ket11, Matrix.mulVec, dotProduct,
