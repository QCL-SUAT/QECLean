...
@[simp] lemma X_q1_2_on_ket00 : X_q1_2 • |00⟩ = |10⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (X_q1_2 : Matrix TwoQubitBasis TwoQubitBasis ℂ)
      (ket00 : Vector TwoQubitBasis)
    = (ket10 : Vector TwoQubitBasis)
  ext i
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q1_2, tensorGate_val, Xmat, ket00, ket10, Matrix.mulVec,
...
@[simp] lemma X_q1_2_on_ket01 : X_q1_2 • |01⟩ = |11⟩ := by
  ...
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q1_2, tensorGate_val, Xmat, ket01, ket11, Matrix.mulVec,
      dotProduct, Matrix.one_apply, Matrix.of_apply]
...
@[simp] lemma X_q1_2_on_ket10 : X_q1_2 • |10⟩ = |00⟩ := by
  ...
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q1_2, tensorGate_val, Xmat, ket10, ket00, Matrix.mulVec,
      dotProduct, Matrix.one_apply, Matrix.of_apply]
...
@[simp] lemma X_q1_2_on_ket11 : X_q1_2 • |11⟩ = |01⟩ := by
  ...
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q1_2, tensorGate_val, Xmat, ket11, ket01, Matrix.mulVec,
      dotProduct, Matrix.one_apply, Matrix.of_apply]

/-- I ⊗ X: |00⟩ ↦ |01⟩. -/
@[simp] lemma X_q2_2_on_ket00 : X_q2_2 • |00⟩ = |01⟩ := by
  apply Subtype.ext
  change Matrix.mulVec (X_q2_2 : Matrix TwoQubitBasis TwoQubitBasis ℂ)
      (ket00 : Vector TwoQubitBasis)
    = (ket01 : Vector TwoQubitBasis)
  ext i
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q2_2, tensorGate_val, Xmat, ket00, ket01, Matrix.mulVec,
      dotProduct, Matrix.one_apply, Matrix.of_apply]
...
@[simp] lemma X_q2_2_on_ket01 : X_q2_2 • |01⟩ = |00⟩ := by
  ...
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q2_2, tensorGate_val, Xmat, ket01, ket00, Matrix.mulVec,
      dotProduct, Matrix.one_apply, Matrix.of_apply]
...
@[simp] lemma X_q2_2_on_ket10 : X_q2_2 • |10⟩ = |11⟩ := by
  ...
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q2_2, tensorGate_val, Xmat, ket10, ket11, Matrix.mulVec,
      dotProduct, Matrix.one_apply, Matrix.of_apply]
...
@[simp] lemma X_q2_2_on_ket11 : X_q2_2 • |11⟩ = |10⟩ := by
  ...
  rcases i with ⟨i₁, i₂⟩
  fin_cases i₁ <;> fin_cases i₂ <;>
    simp +decide [X_q2_2, tensorGate_val, Xmat, ket11, ket10, Matrix.mulVec,
      dotProduct, Matrix.one_apply, Matrix.of_apply]
